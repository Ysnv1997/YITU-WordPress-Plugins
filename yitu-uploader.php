...
function qcgzxw_scripts_css()
{
	...
	if (is_admin()) wp_enqueue_style('bootstrap', YITU_URL . 'css/bootstrap.min.css', array(), YITU_VERSION);
}
...
//功能启用
if ($Uploader['Content']) {
	add_action('admin_footer', 'admin_scripts_css');
